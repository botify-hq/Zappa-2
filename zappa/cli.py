...
from typing import Optional, List, Dict, Any, KeysView, MutableMapping, Tuple
...
class ZappaCLI:
    ...
    def __init__(self) -> None:
        self._stage_config_overrides: Dict[
            str, Any
    ...
    def stage_config(self) -> Dict[str, Any]:
        ...
        def get_stage_setting(
            stage: str, extended_stages: Optional[List[str]] = None
        ) -> Dict[str, Any]:
    ...
    def handle(self, argv: Optional[str] = None) -> Optional[int]:
        """
        Main function.
...
"""
    ...
    def callback(self, position: str) -> None:
        ...
        if callback:
            ...
            try:  # Prefer callback in working directory
                ...
                module_ = working_dir_importer.find_module(mod_name).load_module(  # type: ignore
                    mod_name
                )
    ...
    def load_settings(
        self,
        settings_file: Optional[str] = None,
        session: Optional[botocore.session.Sessions] = None,
    ) -> Zappa:
        """
        ...
        self.lambda_name = slugify.slugify(self.project_name + "-" + self.api_stage)  # type: ignore
    ...
    def create_package(self, output: Optional[str] = None) -> None:
        ...
        with zipfile.ZipFile(handler_zip, "a") as lambda_zip:  # type: ignore
    ...
    def print_logs(
        ...
        http: bool = False,
        non_http: bool = False,
        force_colorize: Optional[bool] = None,
    ) -> None:
        """
    ...
    def execute_prebuild_script(self) -> None:
        ...
        try:  # Prefer prebuild script in working directory
            ...
            working_dir_importer = pkgutil.get_importer(working_dir)
            module_ = working_dir_importer.find_module(mod_name).load_module(mod_name)  # type: ignore
